/* 
 * Controller that listens for notifications and creates the notification message that is sent to the screen.
 */
app.controller('NotificationsCtrl', ['$scope', '$log', 'SocketService', function ($scope, $log, SocketService) {
  ...
  // For debugging: listen to event that is emitted when a socket connection is established
  /*
