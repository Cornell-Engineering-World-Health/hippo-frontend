        ...
        init: function(apiKey, sessionId, token, cb) {
          ...
          OTSession.session.on({
            ...
            streamCreated: function(event) {
              console.log("[opentok-angular] streamCreated: "+ event.stream.connection.connectionId)
            ...
            sessionDisconnected: function(event) {
              console.log("[opentok-angular] sessionDisconnected: "+event.reason)
              $rootScope.$apply(function() {
        ...
        link: function(scope, element, attrs) {
          ...
          scope.$on('$destroy', function() {
            if (OTSession.session) {
              ...
              console.log("[opentok-angular] destroy: Unpublish")
            }
            else {
              scope.publisher.destroy();
              console.log("[opentok-angular] destroy: Destroy")
            }
